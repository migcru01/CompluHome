...
- Los estudiantes serán dirigidos a la interfaz de [Búsqueda de piso](./6.Arquitectura_y_Diseño_del_Sistema#Interfaz%20Principal).
- Los propietarios serán dirigidos a la interfaz de [Propietarios](./6.Arquitectura_y_Diseño_del_Sistema#Interfaz%20Propietario).
### Casos de uso
...
Al hacer clic en una de estas ofertas, se abrirá una vista más detallada de la respectiva habitación, la [Interfaz detallada](./6.Arquitectura_y_Diseño_del_Sistema#Interfaz%20Detallada).
### Casos de uso
Esta es una lista de los casos de uso desarrollados en esta interfaz:
- Buscar oferta.
...
Si el propietario selecciona cualquiera de las filas, se mostrará una [vista detallada](./6.Arquitectura_y_Diseño_del_Sistema#Interfaz%20Detallada) de la habitación.
